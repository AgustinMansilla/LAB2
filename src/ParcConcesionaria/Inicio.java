...
class inicio {
    ...
    public static void main(String[] args) {
        ...
        Vendedor vendedor05 = new Vendedor("CicerÃ³n", 15357951);
        ...
        Auto auto01 = new Auto(3, "ford", 2020, 254654.0D);
        Auto auto02 = new Auto(4, "toyota", 1985, 254654.0D);
        Auto auto03 = new Auto(3, "Fiat", 1987, 254654.0D);
        Auto auto04 = new Auto(4, "FORDIS", 2019, 254654.0D);
        Auto auto05 = new Auto(3, "card", 2018, 254654.0D);
